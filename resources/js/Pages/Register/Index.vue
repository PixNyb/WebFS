<template>
    ...
    <BreezeAuthenticatedLayout :admin="admin">
        ...
        <div class="relative h-full w-full">
            <div id="create-modal" v-if="adding" tabindex="-1" aria-hidden="true" :class="['overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-1/3 w-full  h-modal md:h-full']">
